...
const TextPortfolio = ({ filterData }) => {
                ...
                {filterData.map((data) => (
                    <div key={data.id}>
                        ...
                        <div className="ml-5 text-gray-400">
                            <div className="flex items-center flex-wrap 375:mt-2  sm:mt-3 gap-2 cursor-default md:absolute z-10 text-xs 500:text-sm md:backdrop-blur-lg xl:backdrop-blur-none md:w-[190%] 811:w-[170%] 1024:w-[120%] 1160:w-full">
